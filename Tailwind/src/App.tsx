...
function App() {
  ...
  return (
    <div className={`${darkMode ? "dark" : ""} m-auto bg-lightColor-background text-lightColors-primary dark:bg-darkColors-background dark:text-darkColors-primary `}>
		...
		<ContentCard>
			...
			<Section title='Contact Us' id="contact" className="mb-10">
				<ContactForm/>
			</Section>
		</ContentCard>
